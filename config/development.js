...
module.exports = {
  ...
  connection: {
    host: 'localhost', //'platform.ucx.zone',  //'localhost', //'135.181.62.49', //
...
//      }
  ...
  database: {
    database: 'sql5431252', //'ucxzone_ucxz', //'sql5431252', //'sql5431252', //
    username: 'sql5431252', //'ucxzone_remote', //'sql5431252', //'ucxzone_ucxz',//'sql5431252', //'ucxzone_remote', //'sql5431252', //
    password: 'JmeY3URIRj', //'wW4Fds9v', //'JmeY3URIRj', //'wW4Fds9v', //'wW4Fds9v', //'JmeY3URIRj', //
    host: 'sql5.freemysqlhosting.net', //'localhost', //'sql5.freemysqlhosting.net', //'sql5.freemysqlhosting.net', //'localhost', //
    port: 3306,
    dialect: 'mysql',
    debug: true,
    sync: false,
